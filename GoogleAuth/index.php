...
// $_SESSION["UserType"] = $_POST['category'];
 if(strlen(trim($usernameEmail))>1 && strlen(trim($password))>1 )
   ...
   {
       $errorMsgLogin="Please provide a password";
   }
}
...
if (!empty($_POST['signupSubmit'])) 
{
    ...
    else
    {
      ...
      if(!$email_check){
        $errorMsgReg="Enter email details.";
    }
    if(!$password_check){
        $errorMsgReg="Enter password details.";
    }
    }
...
<body>
<div id="container">
    <h1>Register yourself or login to find the best suitable job/employee</h1>
<div id="login">
<h3>Login</h3>
